...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/laravel-v5.1.11/public/css/weui.css">
  <link rel="stylesheet" href="http://localhost/laravel-v5.1.11/public/css/book.css">
</head>
<body>
<div class="bk_title_bar">
  <img class="bk_back" src="http://localhost/laravel-v5.1.11/public//images/back.png" alt="" onclick="history.go(-1);">
  <p class="bk_title_content"></p>
  <img class="bk_menu" src="http://localhost/laravel-v5.1.11/public//images/menu.png" alt="" onclick="onMenuClick();">
</div>
<div class="page">
  @yield('content')
</div>
