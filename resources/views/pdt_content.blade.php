...
@section('content')
 <link rel="stylesheet" href="http://localhost/laravel-v5.1.11/public/css/swipe.css">
...
@section('my-js')
<script src="http://localhost/laravel-v5.1.11/public/js/swipe.min.js"></script>
<script src="http://localhost/laravel-v5.1.11/public/js/jquery-1.11.2.min.js"></script>
